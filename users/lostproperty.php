...
<html lang="en">
  <head>
    ...
    <title>Request for lost property</title>
...
<div class="panel panel-warning" style="margin:20px;">
	<div class="panel-heading">
        	<h3 class="panel-title">Request for lost property</h3>
	</div>
...
<div class="col-md-12 col-sm-12">
	...
	<div class="form-group col-md-6 col-sm-6">
            <label for="pincode">Place where propert was lost*</label>
            <input type="text" class="form-control input-sm" id="pincode" placeholder="">
        </div>

	<div class="form-group col-md-6 col-sm-6">
	      <label for="address">brief discription of the property*</label>
	      <textarea class="form-control input-sm" id="address" rows="3"></textarea>
	   </div>
	   
	   
	   <div class="form-group col-md-6 col-sm-6">
            <label for="arrival">Missing from Date</label>
            <input type="text" class="form-control input-sm datepicker" id="arrival" placeholder="">
        </div>
		<div class="form-group col-md-6 col-sm-6">
            <label for="arrival">to Date</label>
            <input type="text" class="form-control input-sm datepicker" id="arrival" placeholder="">
        </div>
	<div class = "form-group col-md-6 col-sm-6">
	      <label for="years">  Select Property Type</label>	 
	...
	<div class="form-group col-md-3 col-sm-3">
	    ...
	    <p class="help-block">Please upload any photo of the property if available (any bill or legal document)</p>
	</div>
	<div class="form-group col-md-3 col-sm-3">
	    <label for="photo">Address proof*</label>
	    <input type="file" id="photo">
	    <p class="help-block">Please upload your Address proof*.</p>
	</div>
