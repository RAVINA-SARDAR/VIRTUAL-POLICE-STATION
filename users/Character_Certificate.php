...
<div class="panel panel-warning" style="margin:20px;">
	<div class="panel-heading">
        	<h3 class="panel-title">Character Certificate</h3>
	</div>
...
<div class="col-md-12 col-sm-12">
	...
	<div class="form-group col-md-6 col-sm-6">
	      ...
	      <textarea class="form-control input-sm" id="address" rows="3"  placeholder="enter your permanant address"></textarea>
	   </div>
...
<div class="form-group col-md-6 col-sm-6">
		...
		<div class="form-group col-md-6 col-sm-6">
            <label for="pincode">Organization name applying for </label>
            <input type="text" class="form-control input-sm" id="pincode" placeholder="">
        </div>
		<div class="form-group col-md-6 col-sm-6">
            <label for="country">Any relative Name*</label>
            <input type="text" class="form-control input-sm" id="country" placeholder="">
        </div>

	<div class="form-group col-md-6 col-sm-6">
            <label for="pincode">Relation Type</label>
            <input type="text" class="form-control input-sm" id="pincode" placeholder="">
        </div>
		
	<div class = "form-group col-md-6 col-sm-6">
	      <label for="years">Identification Type</label>	 
		<span class="help-block">Please choose any legal identity type</span>
...
<div class="form-group col-md-6 col-sm-6">
            <label for="pincode">enter selected indentity card number</label>
            <input type="text" class="form-control input-sm" id="pincode" placeholder="">
        </div>
		

	<div class="form-group col-md-6 col-sm-6" >
            <label for="pincode">Do you have any criminal records before  ? 
	    <input type="checkbox" checked data-toggle="toggle"></label>
	    <span class="help-block">if you have any criminal records please mention below</span>
...
<div class="col-md-12 col-sm-12" id="deceased">
	...
	<div class="form-group col-md-3 col-sm-3">
            <label for="photo">Upload identity proof*</label>
	    <input type="file" id="photo">
	    <p class="help-block">Please upload identity photo. Group photo is not acceptable.</p>
	      </div>
	<div class="form-group col-md-3 col-sm-3">
            <label for="age">additional information if required*</label>
