...
<?php $st='closed';
$query=mysqli_query($con,"select tblapplication.*,users.fullName as name,category.categoryName as catname from tblapplication join users on users.id=tblapplication.userId join category on category.id=tblapplication.app_title where tblapplication.applicationNumber='".$_GET['cid']."'");
...
<tr>
											...
											<td><?php echo htmlentities($row['app_title']);?></td>
											<td><b>Event Place</b></td>
											<td> <?php echo htmlentities($row['app_place']);?></td>
											<td><b>Event Date</b></td>
											<td><?php echo htmlentities($row['event_date']);?>
											</td>
										</tr>
<tr>
											<td><b>Event Time</b></td>
											<td><?php echo htmlentities($row['event_time']);?></td>
											<td ><b>AadharCard Number</b></td>
											<td colspan="3"> <?php echo htmlentities($row['aadhar_no']);?></td>
