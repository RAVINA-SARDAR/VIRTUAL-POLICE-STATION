...
<html lang="en">
  <head>
    ...
    <title>VPS | Application Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Application Details</h3>
            <hr />

 <?php $query=mysqli_query($con,"SELECT * FROM `tblapplication` WHERE applicationNumber='".$_GET['cid']."'");
while($row=mysqli_fetch_array($query))
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Application Number : </b></label>
          		<div class="col-sm-4">
          		<p><?php echo htmlentities($row['applicationNumber']);?></p>
          		</div>
...
<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Application Title:</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['app_title']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Application Place :</b> </label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['app_place']);?></p>
              </div>
            </div>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Event Date :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['event_date']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Event Time :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['event_time']);?></p>
              </div>
            </div>  
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Aadharno,  :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['aadhar_no']);?></p>
              </div>
