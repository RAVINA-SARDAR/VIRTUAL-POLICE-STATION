...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Your Application Hstory</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
  <?php $query=mysqli_query($con,"select * from `tblapplication` where userId='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query))
{
  ?>
                              <tr>
                                  <td align="center"><?php echo htmlentities($row['applicationNumber']);?></td>
...
<?php } ?>
                                   <td align="center">
                                   <a href="application-details1.php?cid=<?php echo htmlentities($row['applicationNumber']);?>">
