...
<div class="panel panel-warning" style="margin:20px;">
	<div class="panel-heading">
        	<h3 class="panel-title">Protest Request</h3>
	</div>
...
<div class="form-group col-md-6 col-sm-6">
            <label for="state">Name of Institution/Person (against which protest is planned)*</label>
            <input type="text" class="form-control input-sm" id="state" placeholder="">
        </div>

	<div class="form-group col-md-6 col-sm-6">
	      <label for="address">Address where protest is planned*</label>
	      <textarea class="form-control input-sm" id="address" rows="3"></textarea>
	   </div>
	
	<div class="form-group col-md-6 col-sm-6">
            <label for="city">Discription of Protest/Strike*</label>
	      <textarea class="form-control input-sm" id="address" rows="3"></textarea>
        </div>
	...
	<div class = "form-group col-md-6 col-sm-6">
	            <label for="pincode"> Select type of protest </label>

		<select class="form-control input-sm" id="years">
		<option>-- Select type of protest --</option>
		<option>economic strick</option>
		<option>sympathetic strick</option>
		<option>General strick</option>
		<option>Sit down Strick</option>
		<option>Slow down Strick</option>
		<option>Hunger Strick</option>
		<option>Wild cat strick</option>
		<option>All-out strick</option>
		  </select>
	</div>

	<div class = "form-group col-md-6 col-sm-6">
	      <label for="months">No of hours protest is excepted to be carried out !! </label>
	...
	<div class="form-group col-md-6 col-sm-6" >
            <label for="pincode">Is there any medical emergency help availabe on the spot at the time of protest ? 
	    <input type="checkbox" checked data-toggle="toggle"></label>
	</div>

	<div class="form-group col-md-6 col-sm-6">
            <label for="arrival">Date of protest</label>
            <input type="text" class="form-control input-sm datepicker" id="arrival" placeholder="">
        </div>
</div>
<div class="form-group col-md-3 col-sm-3">
	    <label for="photo">Upload necessary document related to same*</label>
