...
<label class="col-sm-2 col-sm-2 control-label">Location of Crime</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Type of Crime</label>
 <div class="col-sm-4">
<select name="subcategory" id="subcategory" class="form-control" >
<option value="">Select Type of Crime</option>
<?php $sql1=mysqli_query($con,"SELECT`subcategory`FROM `subcategory` ");
while ($rw1=mysqli_fetch_array($sql1)) {
  ?>
  <option value="<?php echo htmlentities($rw1['id']);?>"><?php echo htmlentities($rw1['subcategory']);?></option>
<?php
}
?>
...
<div class="col-sm-4">
<input type="text" name="noc" placeholder=" Ex :  9090-6785-2345" required="required" value="" required="" class="form-control">
</div>
