...
<html lang="en">
  <head>
    ...
    <title>Procession request </title>
...
<div class="panel panel-warning" style="margin:20px;">
	<div class="panel-heading">
        	<h3 class="panel-title">Procession request</h3>
	</div>
...
<hr>
	...
	<div class="form-group col-md-6 col-sm-6">
        ...
        <div class="form-group col-md-6 col-sm-6">
            <label for="email">event discription*</label>
				      <textarea class="form-control input-sm" id="address" rows="3"></textarea>

        </div>

        <div class="form-group col-md-6 col-sm-6">
            <label for="mobile">Mention all stalls to be organized on the event  </label>
            		<span class="help-block">(if planning for for example* tea stall , food stalls) mention number of stalls in total</span>

				      <textarea class="form-control input-sm" id="address" rows="3"></textarea>
        </div>

	<div class="form-group col-md-6 col-sm-6">
	      <label for="address">Breif synopis about the artists *</label>
	      <textarea class="form-control input-sm" id="address" rows="3"></textarea>
	   </div>
	
	<div class="form-group col-md-6 col-sm-6">
	  <label for="pincode">is there use of loudspeaker ? * 
	    <input type="checkbox" checked data-toggle="toggle"></label>
	    
     </div>
	 <div class="form-group col-md-6 col-sm-6">
	  <label for="pincode">is there safety measures for medical emergency ? * 
	    <input type="checkbox" checked data-toggle="toggle"></label>
	    
     </div>
	
	<div class="form-group col-md-6 col-sm-6">
            <label for="state">expected strength of audience *</label>
            <input type="text" class="form-control input-sm" id="state" placeholder="">
        </div>

	<div class="form-group col-md-6 col-sm-6">
            <label for="country">location of performance*</label>
            <input type="text" class="form-control input-sm" id="country" placeholder="">
        </div>
<div class="form-group col-md-6 col-sm-6">
		...
		<div class="form-group col-md-6 col-sm-6">
            <label for="arrival">end Date</label>
            <input type="text" class="form-control input-sm datepicker" id="arrival" placeholder="">
        </div>
		<div class="form-group col-md-6 col-sm-6">
            <label for="arrival">Proposed time limit of the show</label>
            <input type="text" class="form-control input-sm " id="arrival" placeholder="">
        </div>
</div>

<div class="col-md-12 col-sm-12" id="deceased">
        	<center><h3>committee Details</h3><center>
<hr>

	<div class="form-group col-md-3 col-sm-3">
            <label for="name">Organization committee Name*</label>
            <input type="text" class="form-control input-sm" id="name" placeholder="">
        </div>
	<div class="form-group col-md-3 col-sm-3">
            <label for="gender">Number of member*</label>
            <input type="text" class="form-control input-sm" id="gender" placeholder="">
        </div>
	<div class="form-group col-md-3 col-sm-3">
	    <label for="photo">upload necessary document*</label>
