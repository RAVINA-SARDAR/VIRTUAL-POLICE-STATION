...
$ret=mysqli_query($con,"SELECT * FROM `commisoner`WHERE username='$username' and password='$password'");
...
<head>
	...
	<title>VPS | COMMISONER login</title>
...
<body>
		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="../">
			  		Virtual Police Station | COMMISONER
			  	</a>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2019 Complaint Management System </b> All rights reserved.
		</div>
