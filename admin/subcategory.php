...
$sql=mysqli_query($con,"insert into subcategory(subcategory) values('$subcat')");
...
<head>
	...
	<title>Admin| Type of Crime</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Type of Crime Name:</label>
<div class="controls">
<input type="text" placeholder="Enter Types"  name="subcategory" class="span8 tip" required>
</div>
</div>
