...
<tr>
 ...
 $po_name= $_SESSION['alogin'];
 $ret1=mysqli_query($con,"SELECT * FROM `admin` WHERE username='$po_name'");
while($rw1=mysqli_fetch_array($ret1))
{

?>
<a href="javascript:void(0);" onClick="popUpWindow('updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>&po_na=<?php echo $_SESSION['alogin'];?>&poid=<?php echo htmlentities($rw1['ADC_NO']);?>&podes=<?php echo htmlentities($rw1['desgination']);?>');" title="Update order">
