...
<label class="control-label" for="basicinput">Type Of Crime</label>
<div class="controls">
<input type="text" placeholder="Enter Types"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
